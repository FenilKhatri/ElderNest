...
const Caregivers = () => {
  ...
  const emptyStateContent = (
    <div className="text-center bg-white dark:bg-slate-800 rounded-2xl p-16 border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col items-center justify-center h-full min-h-[300px]">
  ...
  const renderCaregiverCard = (caregiver) => (
    <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-all flex flex-col h-full group">
      {/* Top: Image & Name */}
  ...
  return (
    <ListingPageLayout 
      ...
      subtitle="Browse through our network of verified, experienced nurses and attendants ready to provide compassionate care for your loved ones."
