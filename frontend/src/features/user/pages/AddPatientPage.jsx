  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 max-w-4xl pb-10">
        ...
        <motion.div variants={fadeUp} initial="hidden" animate="show" className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-1">
              <Input label="Full Name *" {...register("name")} placeholder="Patient full name" />
            ...
            <div className="space-y-1">
              <Select label="Gender *" {...register("gender")} options={GENDER_OPTIONS} placeholder="Select gender" />
              {errors.gender && <p className="text-red-500 text-xs">{errors.gender.message}</p>}
            </div>
            <div className="space-y-1">
               <Select label="Blood Group" {...register("bloodGroup")} options={BLOOD_GROUPS} />
            </div>
            <div className="space-y-1">
              <Input label="Height" {...register("height")} placeholder="e.g. 5'6'' or 168cm" />
            </div>
            <div className="space-y-1">
              <Input label="Weight" {...register("weight")} placeholder="e.g. 65kg" />
            </div>
            <div className="space-y-1">
              <Input label="Primary Language" {...register("primaryLanguage")} placeholder="e.g. English, Hindi" />
            </div>
            <div className="space-y-1">
              <Input label="Relationship to you *" {...register("relationship")} placeholder="e.g. Mother, Father, Self" />
        ...
        <motion.div variants={fadeUp} initial="hidden" animate="show" className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
          ...
          <div className="p-6 space-y-6">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-slate-100 dark:border-slate-800">
               <div className="space-y-1">
                 <Select label="Mobility Status" {...register("mobilityStatus")} options={[
               ...
               <div className="space-y-1">
                 <Input label="Dietary Restrictions" {...register("dietaryRestrictions")} placeholder="e.g. Diabetic Diet, Low Salt" />
               </div>
             </div>
          </div>
        </motion.div>
