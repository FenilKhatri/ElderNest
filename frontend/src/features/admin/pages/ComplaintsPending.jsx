  ...
  return (
    <motion.div variants={stagger} initial='hidden' animate='show' className='space-y-6'>
      <motion.div variants={fadeUp} className='flex items-center justify-between'>
        <div>
          <h1 className='text-2xl font-bold text-slate-900 dark:text-white'>ComplaintsPending</h1>
          <p className='text-slate-500 dark:text-slate-400 mt-1'>Manage ComplaintsPending.</p>
        </div>
      </motion.div>
