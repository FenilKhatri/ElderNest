...
const Footer = () => {
  const footerLinks =
    "text-slate-400 font-semibold hover:text-[#FF3366] transition duration-300";
  ...
  return (
    <>
      <footer className="bg-slate-50 border-t border-slate-200">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-3 px-5 py-10">
          ...
          <div className="col-span-2 flex flex-col items-start justify-start gap-3">
            ...
            <p className="text-slate-500 max-w-sm">
              Providing compassionate, professional, and reliable home
              healthcare services for your loved ones.
            </p>
          </div>
          ...
          <div className="col-span-3">
            <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 gap-3">
              ...
              <div className="col-span-1 flex flex-col gap-5 items-start justify-start">
                <p className="font-bold text-slate-800">For Professionals</p>
                <ul className="space-y-3">
                  <li>
        ...
        {/* Copyright reserved */}
        <div className="w-full max-w-7xl mx-auto border-t border-slate-300 flex flex-col md:flex-row items-center justify-between gap-3 text-slate-500 py-10 px-5">
          <p>&copy; CareHome Healthcare Services. All rights reserved.</p>
          <div className="flex items-center gap-5">
            <Link className="hover:text-[#FF3366]">Pricay Policy</Link>
            <Link className="hover:text-[#FF3366]">Terms of Service</Link>
          </div>
        </div>
      </footer>
    </>
